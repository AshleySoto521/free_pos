...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::iniciar_inventario,
            commands::actualizar_precios,
            ...
            commands::reporte_movimientos,
            commands::reporte_utilidad,
            commands::reporte_inventario_valorizado,
            commands::historial_producto,
            commands::kardex_valorizado,
            // --- Caja (cortes) ---
